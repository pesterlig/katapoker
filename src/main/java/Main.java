...
public class Main {
    ...
    private static void displayPencilDemoMenu() {
        System.out.println();
    ...
    public static String evaluateHands(String input) {
        try {
            PokerHand black = new PokerHand("black");
            String handBlack = input.split(" {2}")[0];
            ...
            String handWhite = input.split(" {2}")[1];
            ...
            return judge.compareHandsForWin(pokerHands);
        } catch (Exception e) {
